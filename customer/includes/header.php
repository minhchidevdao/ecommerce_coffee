...
<body>
    ...
    <div id="navbar" style="border: black;" class="navbar navbar-default"><!-- navbar navbar-default Begin -->
        ...
        <div class="container"><!-- container Begin -->
            ...
            <div class="navbar-header"><!-- navbar-header Begin -->
                ...
                <a href="../index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                    ...
                    <img src="logo_minhchi.png" style="height: 50px; width:60px" alt="Logo" class="hidden-xs">
                    <img src="logo_minhchi.png" style="height: 50px; width:60px" alt="Logo" class="visible-xs">
