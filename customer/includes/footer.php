    ...
    <div class="container"><!-- container Begin -->
        <div class="row"><!-- row Begin -->
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4 style="color:antiquewhite">Trang</h4>
                ...
                <h4 style="color:antiquewhite">Người dùng</h4>
            ...
            <div class="com-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <h4 style="color:antiquewhite">Danh mục sản phẩm hàng đầu</h4>
            ...
            <div style="color:antiquewhite" class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                
                <h4>Về chúng tôi</h4>
                
                <p style="color:antiquewhite"><!-- p Start -->
                    

                    
                    <br/><strong>Shop</strong>
                    <br/><strong>Địa chỉ cửa hàng:</strong> Bắc Từ Liêm,<br>Hà Nội, Việt Nam
                    <br/><strong>SĐT của hàng:</strong> 01234567
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2022 Store All Rights Reserve</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">store</a></p>
