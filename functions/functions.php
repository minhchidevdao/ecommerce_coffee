...
$db = mysqli_connect("localhost","root","","store_coffee");
        ...
        if($count==0){
            ...
            echo "
                ...
                <div class='box'>
                    ...
                    <h1 style='color:#ffffff'> $p_cat_title </h1>
                    
                    <p style='color:#f6cfcf'> $p_cat_desc </p>
        ...
        if($count==0){
            ...
            echo "
                ...
                <div class='box'>
                    ...
                    <h1 style='color:#ffffff'> $cat_title </h1>
                    
                    <p style='color:#f6cfcf'> $cat_desc </p>
