...
<div class="row"><!-- row no: 1 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <h1 style="color:aliceblue" class="page-header"> DashBoard </h1>
...
<div class="row"><!-- row no: 2 begin -->
    ...
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            ...
            <div style="color:#372525" class="panel-heading"><!-- panel-heading begin -->
...
<div class="row"><!-- row no: 3 begin -->
    <div class="col-lg-8"><!-- col-lg-8 begin -->
        <div class="panel panel-primary" style="border-color:#372525"><!-- panel panel-primary begin -->
            <div style="background-color:#372525; border-color:#372525" class="panel-heading" ><!-- panel-heading begin -->
