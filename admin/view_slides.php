...
<div class="row"><!-- row 2 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <div style="border-color:black;" class="panel panel-default"><!-- panel panel-default begin -->
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <div class="col-lg-3 col-md-3"><!-- col-lg-3 col-md-3 begin -->
                    <div class="panel panel-secondary"><!-- panel panel-primary begin -->
                        <div class="panel-heading"><!-- panel-heading begin -->
                        ...
                        <div class="panel-body  border border-dark"><!-- panel-body begin -->
